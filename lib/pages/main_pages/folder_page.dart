...
class FolderPage extends StatelessWidget {
              ...
              sliver: SliverGrid(
                ...
                delegate: SliverChildBuilderDelegate((context, i) {
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () => _openFolder(context, provider, folderName),
  ...
  void _openFolder(BuildContext context, TaskProvider provider, String folder) {
    // Push a page which listens to TaskProvider (using Consumer)
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => Consumer<TaskProvider>(
          builder: (c, prov, _) {
            final folderTasks = prov.tasksInFolder(folder);
            return Scaffold(
              body: CustomScrollView(
                physics: const BouncingScrollPhysics(),
                slivers: [
                  ...
                  if (folderTasks.isEmpty)
                    SliverFillRemaining(
                      child: Center(child: Text('No tasks in "$folder"')),
                    )
                  else
                    SliverPadding(
                        ...
                        delegate: SliverChildBuilderDelegate((context, index) {
                          ...
                          return Padding(
                            ...
                            child: MyListItem(
                              ...
                              onLongPress: () => _showTaskBottomSheet(
                                c,
                                prov,
                                realIndex,
                                task,
